...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'coach', element: <LegacyLearnRedirect /> },
      ...
      { path: 'projects/:projectId/learn', element: <LearnPage /> },
      { path: 'projects/:projectId/coach', element: <LegacyProjectCoachRedirect /> },
